...
class SubmonThemeExtension extends ThemeExtension<SubmonThemeExtension> {
  ...
  @override
  ThemeExtension<SubmonThemeExtension> lerp(
      covariant SubmonThemeExtension? other,
      double t,
      ) {
    return SubmonThemeExtension(
      safeDueTextColor:
      Color.lerp(safeDueTextColor, other?.safeDueTextColor, t)!,
      nearDueTextColor:
      Color.lerp(nearDueTextColor, other?.nearDueTextColor, t)!,
      overdueTextColor:
      Color.lerp(overdueTextColor, other?.overdueTextColor, t)!,
