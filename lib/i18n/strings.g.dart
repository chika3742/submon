...
import 'strings_en_US.g.dart' as l_en_US;
part 'strings_ja_JP.g.dart';

/// Supported locales.
///
/// Usage:
/// - LocaleSettings.setLocale(AppLocale.jaJp) // set locale
/// - Locale locale = AppLocale.jaJp.flutterLocale // get flutter locale from enum
/// - if (LocaleSettings.currentLocale == AppLocale.jaJp) // locale check
